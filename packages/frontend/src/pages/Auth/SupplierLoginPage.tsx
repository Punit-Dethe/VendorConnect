...
import { Eye, EyeOff, Store, Building } from 'lucide-react'
  ...
  useEffect(() => {
    if (isAuthenticated && user) {
      if (user.role === 'supplier') {
        ...
        toast.error('Please use the vendor login page')
        dispatch(clearError())
      }
    }
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Sign in to manage your business and serve vendors
          </p>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-lg">
            ...
            <p className="text-sm text-green-700">
              Mobile: <strong>9876543211</strong><br />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="text-center">
                <span className="text-sm text-gray-600">Are you a vendor? </span>
                <Link
                  to="/vendor/login"
